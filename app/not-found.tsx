  ...
  <div className="h-screen w-screen flex items-center">
    <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
      <div className="max-w-md">
        ...
        Tyvärr kunde vi inte hitta den här sidan.{" "}
        </p>
        <Link href="/">
         <Button  className="bg-yellow-500 text-black hover:bg-yellow-600 mt-4">
        Gå tillbaka till startsidan
        </Button>
        </Link>
       
        {/* <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-yellow-500 active:bg-yellow-500 hover:bg-yellow-700">
          Gå tillbaka till startsidan
        </button> */}
      </div>
